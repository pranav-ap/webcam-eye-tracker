...
try:
  ...
  import VideoCapture
	...
	raise Exception("VideoCapture module not available")
...
class Setup:
	...
	def run_GUI(self):
		...
		while running:
			...
			if (old_pos[0] > pupilpos[0]):
				print "moved right"
			elif (old_pos[0] < pupilpos[0]):
				print "moved left"

			if (old_pos[1] > pupilpos[1]):
				print "moved down"
			elif (old_pos[0] < pupilpos[0]):
				print "moved up"

			division = pupilpos[0] - pupilpos[1] / old_pos[0] - old_pos[1]
